...
describe('jwt', () => {
  it('should create a jwt', async () => {
    const jwt = await createJwt("ba944fbd34d27877ba0787856b2afc163d2b54d2c3ad0f152bae011ce3f91687", {
    ...
    console.log(await verifyJwt(jwt, "did:iota:FPWiRYAG6F2xyHavCG5MRFsR76NQPb9RLz2GGjwEih88"));
  });
});
